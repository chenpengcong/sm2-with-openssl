 ...
 * @param cipher_text [OUT]密文数据, ASN.1 DER编码。如果cipher_text为NULL，cipher_text_len参数将会返回密文的可能最大长度
 ...
 * @param plain_text [OUT]明文，如果plain_text为NULL，plain_text_len参数将会返回明文的可能最大长度
